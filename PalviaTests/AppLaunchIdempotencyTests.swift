...
/// sweeps in `PalviaApp.init()` cascading through observation back into
/// body evaluation.
///
...
final class AppLaunchIdempotencyTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        PalviaApp.resetLaunchStateForTesting()
    }
    ...
    func testFlagIsSetBeforeWorkRuns() {
        ...
        PalviaApp.runOneTimeLaunchTasksIfNeeded {
            observedFlagDuringWork = PalviaApp.didRunOneTimeLaunchTasks
        }
